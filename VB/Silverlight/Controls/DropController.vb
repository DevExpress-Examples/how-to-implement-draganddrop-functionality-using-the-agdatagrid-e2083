	...
	Public Class DropController
		...
		Public Sub New(ByVal dataGrid As AgDataGrid, ByVal dropContainer As FrameworkElement, ByVal dragSurface As Canvas)
			...
			If Me._dataGrid IsNot Nothing Then
				...
				'this._dataGrid.NewDataRow += new NewDataRowEventHandler(OnNewDataRow);
		...
		Private Sub _dataGrid_DataRowCreated(ByVal sender As Object, ByVal e As DataRowCreatedEventArgs)
